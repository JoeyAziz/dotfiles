		...
		opts = {
			...
			servers = {
				...
				gopls = {
					...
					settings = {
						gopls = {
							...
							directoryFilters = vim.tbl_filter(function(v)
								return v ~= nil
							end, {
								"-bazel-bin",
								"-bazel-out",
				...
				ts_ls = {
					...
					-- Bump tsserver's V8 heap; default ~4GB OOMs on the telda-fe monorepo
					-- (SIGABRT from node::OOMErrorHandler in DiagnosticReports).
					init_options = {
